...
1.  使用**成本计算版本****设置**页可以使成本数据输入到第二个成本计算版本中。 可以选择阻止启用未决成本，以便在未决成本已完全和精确定义后允许启用。 您还可以选择在**开始日期**字段中输入日期。 一般而言，使用您想要启用增量更新时的日期。 或者，则将成本计算版本的**开始日期**字段留空，则在每个成本记录的**开始日期**字段中输入日期。
