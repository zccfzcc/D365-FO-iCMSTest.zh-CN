...
现金流量预测可与总帐、应付账款、应收账款、预算和库存管理集成。 预测流程使用在系统中输入的交易记录信息，而计算流程预测各个交易记录的预期现金影响。 在计算现金流量时考虑以下类型的交易记录：

- **销售订单** - 尚未开票且导致实际销售或财务销售的销售订单。
- **采购订单** - 尚未开票且导致实际采购或财务采购的采购订单。
- **应收账款** - 未结客户交易记录（尚未付款的发票）。
- **应付账款** - 未结供应商交易记录（尚未付款的发票）。
...
您可以使用**现金流量预测设置**页的**应付账款**选项卡上的设置选项计算采购预测。 您可以为应付账款配置现金流量预测前，必须配置付款期限、供应商组和供应商过帐模板。
...
您可以使用**现金流量预测设置**页的**应收账款**选项卡上的设置选项计算销售预测。 您可以为应收账款配置现金流量预测前，必须配置付款期限、客户组和客户过帐模板。
