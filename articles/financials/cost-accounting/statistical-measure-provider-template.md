...
统计度量可以源自许多类型的来源。 Microsoft Dynamics 365 for Finance and Operations 是提取统计度量的出色来源。 您可以统计度量提供方模板轻松配置您要提取的统计度量。
...
| 姓名        | 数据连接器                                                                     | 统计维度成员 |
|-------------|------------------------------------------------------------------------------------|------------------------------|
| FTEs D365FO | Dynamics 365 for Finance and Operations – 统计度量 | FTE                         |
...
| 姓名           | 数据连接器                                                                     | 统计维度成员 |
|----------------|------------------------------------------------------------------------------------|------------------------------|
| 包装 CC D365FO | Dynamics 365 for Finance and Operations – 统计度量 | 包装 CC                      |
