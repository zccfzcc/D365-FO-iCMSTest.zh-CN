...
下表列出了 Finance and Operations 中支持的登记类型。 如果您熟悉登记 ID 的 Microsoft Dynamics AX 2012 字段，此表还将这些字段映射到 Finance and Operations 登记类别。

| Finance and Operations Registration 类别         |国家/地区  | Dynamics AX 2012 术语/字段|
|---------------------------------------------------------------|---------------------|---------------------------------|
