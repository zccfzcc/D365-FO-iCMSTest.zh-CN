...
创建新目录时，首先必须将其链接到一个或多个零售渠道。 此操作在**目录设置**窗体的**零售渠道**中执行。 单击**添加**，然后选择一个或多个零售渠道。 创建目录时，只能使用已链接到您选择的渠道[分类](https://docs.microsoft.com/en-us/dynamics365/unified-operations/retail/assortments)的项。
