...
分类是您分配给零售渠道相关产品的集合，例如传统砂商店和实体店或在线商店。 您使用分类标识每个商店中可用的产品。 分类可以包括产品的类别。 因此，分配给包括在此分类中特定类别的所有产品。 分类还可以包括特定产品和产品的特定款式。 通过设置分类，可以同时将上千种产品以商店需要的任意组合分配到您的零售渠道。 如果您需要可以设置多个产品分类。 每个产品可以包括在一个或多个分类中，并且每个分类可以分配给一个或多个零售渠道。 例如，您可以定义包含基本产品组的一个分类。 所有商店接收此分类。 然后定义另一个分类，其中仅包括大型体育设备。 只有您的更大商店接收此分类。 下图显示如何分配产品给分类，并且这些分类如何可分配给零售渠道。 ![产品分类关系](./media/assortments_relationship.gif)
