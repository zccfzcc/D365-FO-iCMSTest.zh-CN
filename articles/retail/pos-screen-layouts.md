...
- **按钮属性** – 您可以通过右键单击按钮和使用快捷菜单配置按钮属性。
    ...
    > [!IMPORTANT]
    > 某些按钮网格设置仅适用于 Enterprise POS，不适用于 Retail Modern POS 或 Cloud POS。
    ...
    - **自定义主题** – 默认情况下，POS 按钮使用可视化配置文件中的主题颜色。 如果选中**使用自定义主题**复选框，则可指定更多颜色。
        ...
        > [!NOTE]
        > Retail Modern POS 和 Cloud POS 仅适用于**背景色**和**字体颜色**值。

    - –**按钮图像** – 按钮中可以包含图像或图标。 可以在**零售 \> 渠道设置 \> POS 设置 \> POS \> 图像**中指定的可用图像内进行选择。
