...
您可以导出构建基块组或构建基块组中的特定报表构建基块。 You can use the exported building block group as a backup. 您还可以复制 Finance and Operations 安装之间的导出数据。 Report designer includes the referenced font styles and dimension sets together with the building block group.
