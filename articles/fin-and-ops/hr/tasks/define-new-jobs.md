...
4. 在“描述”字段中，键入一个值。
5. 选择将用于该作业的标准标题。 
    * 标题上输入的值将用作默认为新的职位分配给作业。  
6. 在列表中，找到并选择所需记录。
7. 在列表中，单击所选行中的链接。
8. 在最大职位分组数中，选择“最大职位数”
9. 输入最大职位数。 
    * 职位分配数不得高于此处输入的最大值。  
10. 切换“描述”部分的扩展。
11. 在“注释”字段中，输入该作业的标准描述。
    * 该描述适用于分配至此处所定义作业的所有职位。  
12. 切换“作业分类”部分的扩展。
13. 选择将用于人力资源中的标准报表的工作职能。
14. 在列表中，找到并选择所需记录。
15. 在列表中，单击所选行中的链接。
16. 选择作业类型，以进一步将您的组织中的作业分类。 
    * 作业类型可在整个人力资源报告过程中使用。  
17. 在列表中，找到并选择所需记录。
18. 在列表中，单击所选行中的链接。
19. 切换“薪酬”部分的扩展。
20. 选择薪酬级别。
    * 薪酬水平将定义员工就工作可拥有的最少和最多薪酬。 薪酬规则将确定员工的薪酬是否超出范围之外。  
21. 在列表中，找到并选择所需记录。
22. 在列表中，单击所选行中的链接。
23. 切换“技能”部分的扩展。
