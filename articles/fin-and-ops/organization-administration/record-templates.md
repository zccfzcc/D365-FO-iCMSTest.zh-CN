...
记录模板有助于您在 Microsoft Dynamics 365 for Finance and Operations 中更快地创建记录。 您可以仅为 Microsoft Dynamics 365 for Finance and Operations 中的某些记录类型创建记录模版。 

例如，假设您为旧金山的汽车租赁业务输入租赁信息。 由于大多数客户可能来自旧金山地区，因此如果您能够在租赁窗体上的**州**、**国家/地区**和**城市**字段中自动填入值将是非常理想的。 

> [!Note]
> 您只能将模板应用于您有权访问的 Finance and Operations 的区域。 但在您创建新记录时，所有模板标题均对您可见，如果您创建的是将对所有用户可用的模板，则对其他用户也可见。 请确保在命名模板时考虑到这一点。 例如，如果公司某些员工享受与佣金挂钩的薪酬为秘密，请避免使用如“佣金”之类的词语。 
